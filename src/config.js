...
// set via env: H1=1-4096 H2=1-4096 H3=1-4096 H4=1-4096. See docs/amnezia-protocol-original.md.
...
// I1 — QUIC signature for DPI bypass (client-side only). Default: public Amnezia docs snapshot (~1.5 KB).
// Risk: mass use = fingerprint. Better: capture your own QUIC Initial (Wireshark: udp.port==443 && quic,
// site on QUIC, copy Initial as Hex Stream) and set via env I1=<b 0x...>. See docs/amnezia-protocol-original.md.
