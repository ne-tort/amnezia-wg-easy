...
Скрипт создаёт `.env` при отсутствии, подставляет внешний IP и пароль, поднимает контейнер. Web UI и пароль выводятся в конце.
